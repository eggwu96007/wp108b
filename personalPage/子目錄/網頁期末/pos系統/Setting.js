...
<table>
  ...
  <tbody>
    ...
    <tr><td>附加選項</td><td><textarea id="addsitem"></textarea></td></tr>
  </tbody>
</table>
<br/>
...
Setting.start = function () {
  ...
  Ui.id('addsitem').value = JSON.stringify(Shop.addsitem, null, 2)
...
Setting.save = function () {
  try {
    ...
    Shop.addsitem = JSON.parse(Ui.id('addsitem').value)
  } catch (error) {
  ...
  localStorage.setItem('Shop.addsitem', Ui.id('addsitem').value)
